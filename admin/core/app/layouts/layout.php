...
<html>
  <head>
    <meta charset="UTF-8">
    <title>PortaFoox | Dashboard</title>
    ...
    <div class="wrapper">
      ...
      <header class="main-header">
        ...
        <a href="./" class="logo">
          ...
          <span class="logo-lg"><b>PORTA</b>FOOX</span>
        </a>
...
<div class="user-panel">
        ...
        <li class="treeview">
          ...
          <ul class="treeview-menu">
            <li><a href="./?view=products"><i class="fa fa-circle-o"></i> Proyectos</a></li>
