  ...
  <!-- Button trigger modal -->
            ...
            // print_r($_SESSION);
             if(isset($_SESSION["product_updated"])):?>
              <p class="alert alert-info"><i class="fa fa-check"></i> Proyecto Actualizado Exitosamente</p>
            <?php 
...
<form class="form-horizontal" role="form" enctype="multipart/form-data" method="post" action="index.php?action=updateproduct">
  <div class="form-group">
    ...
    <div class="col-lg-6">
      <input type="text" class="form-control" name="name" value="<?php echo $product->name; ?>" placeholder="Nombre del Proyecto">
    </div>
...
<br>  
<img src="<?php echo $url; ?>" class="img-responsive" width="480">
<?php endif; ?>
    </div>
  </div>
    ...
    <div class="col-lg-offset-2 col-lg-2">
      <div class="checkbox">
        <label>
          ...
          <input type="hidden" name="in_existence" value="0">
          <input type="hidden" name="price" value="0">
    <div class="col-lg-3">
      <div class="checkbox">
        <label>
          <input type="checkbox" name="is_featured" <?php if($product->is_featured){ echo "checked";} ?>> Proyecto destacado
        </label>
      </div>
    </div>
